...
public class MainActivity extends AppCompatActivity implements
    ...
    private static boolean PREFERANCE_UPDATE = false;
    ...
    private void openLocationInMap() {
        ...
        String addressString = sharedPreferences.getString(getString(R.string.pref_location_key), getString(R.string.pref_location_default));
    ...
    protected void onStart() {
        ...
        if (PREFERANCE_UPDATE) {
            invalidateData();
            getSupportLoaderManager().restartLoader(FORECAST_LOADER_ID, null, this);

            PREFERANCE_UPDATE = false;
        }
    }
