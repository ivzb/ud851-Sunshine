...
public class SunshinePreferences {
    ...
    public static boolean isMetric(Context context) {
        ...
        String keyForTemperature = context.getString(R.string.pref_units_key);
        String defaultTemperature = context.getString(R.string.pref_units_metric);

        String temperature = sharedPreferences.getString(keyForTemperature, defaultTemperature);

        if (temperature.equals(context.getString(R.string.pref_units_metric))) {
            return true;
        }
